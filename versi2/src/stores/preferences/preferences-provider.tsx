...
function readDomState(): Partial<PreferencesState> {
  ...
  const showQuickCreateCookie = getClientCookie("show_quick_create");
  const showSidebarTriggerCookie = getClientCookie("show_sidebar_trigger");
  const sidebarMatchBackgroundCookie = getClientCookie("sidebar_match_background");
  ...
  return {
    ...
    showQuickCreate: showQuickCreateCookie !== undefined ? showQuickCreateCookie === "true" : undefined,
    showSidebarTrigger: showSidebarTriggerCookie !== undefined ? showSidebarTriggerCookie === "true" : undefined,
    sidebarMatchBackground:
      sidebarMatchBackgroundCookie !== undefined ? sidebarMatchBackgroundCookie === "true" : undefined,
  };
}
