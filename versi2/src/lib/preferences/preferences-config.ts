...
export type PreferenceValueMap = {
  ...
  show_quick_create: "true" | "false";
  show_sidebar_trigger: "true" | "false";
  sidebar_match_background: "true" | "false";
};
...
export const PREFERENCE_DEFAULTS: PreferenceValueMap = {
  ...
  sidebar_match_background: "false",
};
...
export const PREFERENCE_PERSISTENCE: PreferencePersistenceConfig = {
  ...
  show_quick_create: "client-cookie",
  show_sidebar_trigger: "client-cookie",
  sidebar_match_background: "client-cookie",
};
