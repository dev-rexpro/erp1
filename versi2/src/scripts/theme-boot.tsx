...
export function ThemeBootScript() {
  const persistence = JSON.stringify({
    ...
    sidebar_match_background: PREFERENCE_PERSISTENCE.sidebar_match_background,
  });
  ...
  const defaults = JSON.stringify({
    ...
    sidebar_match_background: PREFERENCE_DEFAULTS.sidebar_match_background,
  });
  ...
  const code = `
    (function () {
      try {
        ...
        var rawSidebarMatchBackground = readPreference("sidebar_match_background", DEFAULTS.sidebar_match_background);
        ...
        var sidebarMatchBackground = rawSidebarMatchBackground || DEFAULTS.sidebar_match_background;
        ...
        root.setAttribute("data-sidebar-match-background", sidebarMatchBackground);
