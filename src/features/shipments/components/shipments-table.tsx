...
export function ShipmentsTable({ data, search, navigate }: DataTableProps) {
  ...
  return (
    <div className={cn(
      ...
      <DataTableToolbar
        table={table}
        searchKey='username'
        searchPlaceholder='Search shipment code...'
        filters={[
          {
            columnId: 'status',
            title: 'Status',
            options: [
              ...
              { label: 'Delivered', value: 'inactive' },
              { label: 'Scheduled', value: 'invited' },
              { label: 'Delayed', value: 'suspended' },
            ],
          },
          {
            columnId: 'role',
