...
export function ContractsTable({ data, search, navigate }: DataTableProps) {
  ...
  return (
    <div className={cn(
      ...
      <DataTableToolbar
        table={table}
        searchKey='username'
        searchPlaceholder='Search contract code...'
        filters={[
          {
            columnId: 'status',
            title: 'Status',
            options: [
              ...
              { label: 'Pending Sign', value: 'invited' },
              { label: 'Terminated', value: 'suspended' },
            ],
          },
          {
            columnId: 'role',
