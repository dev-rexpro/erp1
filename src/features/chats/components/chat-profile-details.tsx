  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4 overflow-y-auto p-4">
      <div className="flex items-start gap-3">
        ...
        <Button variant="ghost" size="icon" className="size-8" aria-label="Close profile" onClick={onClose}>
          <X />
        </Button>
      </div>

      <div className="flex gap-2">
        <Button size="icon" className="size-8" variant="ghost" aria-label="Email">
          <Mail className="size-3.5" />
        </Button>
        <Button size="icon" className="size-8" variant="ghost" aria-label="Call">
          <PhoneCall className="size-3.5" />
        </Button>
        <Button size="icon" className="size-8" variant="ghost" aria-label="Schedule">
          <Calendar className="size-3.5" />
        </Button>
        <Button size="icon" className="size-8" variant="ghost" aria-label="Copy link">
          <Link className="size-3.5" />
        </Button>
        <Button size="icon" className="size-8" variant="ghost" aria-label="More">
