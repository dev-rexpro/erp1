          ...
          <div className="flex items-center gap-1">
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className="size-8" aria-label="Call">
                  <PhoneCall />
                </Button>
              </TooltipTrigger>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className="size-8" aria-label="Tag">
                  <Tag />
                </Button>
              </TooltipTrigger>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className="size-8" aria-label="Snooze">
                  <AlarmClock />
                </Button>
              </TooltipTrigger>
  ...
  return (
    <div className="flex flex-col gap-4 px-3 pb-2">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-1">
          <Button variant="ghost" size="icon" className="size-8" aria-label="Format">
            <Type />
          </Button>
          ...
          <Button variant="ghost" size="icon" className="size-8" aria-label="Insert link">
            <Link />
          </Button>
          <Button variant="outline" size="icon" className="size-8" aria-label="AI assist">
            <Sparkles />
          </Button>
        </div>
