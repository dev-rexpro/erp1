...
import { quotationsColumns as columns } from './quotations-columns'
...
export function QuotationsTable({ data, search, navigate }: DataTableProps) {
  ...
  return (
    <div className={cn(
      ...
      <DataTableToolbar
        table={table}
        searchKey='username'
        searchPlaceholder='Search quotation code...'
        filters={[
          {
            columnId: 'status',
            title: 'Status',
